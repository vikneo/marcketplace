...
from.views import add_product_to_cart, CartViewList, take_product_is_cart, delete_product_from_cart, clear_cart
...
urlpatterns = [
    ...
    path('cart-add/aply/<int:_id>/', take_product_is_cart, name='cart_take'),
